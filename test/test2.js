...
var Parent = (function () {
    function Parent() {
        ...
        this.s = "123";
        this.array = ["1", "2", "3"];
        this.childA = new Child(this);
        this.childB = new Child(this);
    }
    __decorate([
        index_1.jsonIgnore(), 
    ...
    __decorate([
        index_1.jsonReplaceByChildValue("id"), 
        __metadata('design:type', Child)
    ], Parent.prototype, "childA", void 0);
    __decorate([
        index_1.jsonReplaceByConstant("id-2"), 
        __metadata('design:type', Child)
    ], Parent.prototype, "childB", void 0);
    return Parent;
}());
var Child = (function () {
